#!/usr/bin/env python3
"""Extract text and images from 图解缠论3 epub, output as Markdown."""
...
EPUB_PATH = BOOK_DIR / "《图解缠论3》 [陈秋明].epub"
IMG_DIR = BOOK_DIR / "images"
MD_PATH = BOOK_DIR / "图解缠论3.md"
...
def main():
    ...
    lines_out = []
    lines_out.append("# 图解缠论3——技术面、基本面、比价轮动的立体操盘\n\n")
